...
export class index extends Component {
    ...
    hightLightCJText = (cj_text, reg_type,highlights) => {
        ...
        else if (reg_type==='phone')
        {
            ...
            let re_phone=new RegExp("(?:手機號碼|行動號碼|電話號碼|手機電話|行動電話|門號|手機){1}(?:之|為|確為|:|：)?[ 「]{0,2}([0-9]{4}[-─－—–]?[0-9]{3}[-─－—–]?[0-9]{3})(?:SIM)?|[ ]{0,2}([0-9]{4}[-─－—–]?[0-9]{3}[-─－—–]?[0-9]{3})[ 」]{0,2}(?:之)?(?:號行動電話|號SIM|號手機|號電話|行動電話|手機|電話|門號){1}","g")
